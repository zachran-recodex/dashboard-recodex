<div
    class="sticky top-0 z-40 flex items-center h-16 px-4 bg-white border-b border-gray-200 shadow-sm shrink-0 gap-x-4 sm:gap-x-6 sm:px-6 lg:px-8 dark:bg-gray-900 dark:border-gray-800">
    <button type="button" class="-m-2.5 p-2.5 text-gray-700 lg:hidden dark:text-gray-200" @click="sidebarOpen = true">
    ...
    <!-- Separator -->
    <div class="w-px h-6 bg-gray-200 lg:hidden dark:bg-gray-700" aria-hidden="true"></div>
        ...
        <div class="flex items-center gap-x-4 lg:gap-x-6">
            ...
            <div x-data="{ open: false }" class="relative">
                ...
                <div x-show="open" @click.away="open = false"
                    ...
                    <div class="px-4 py-2 text-sm text-gray-700 dark:text-gray-200">No new notifications</div>
                </div>
            </div>
