        ...
        <div class="lg:max-w-[464px] mx-auto w-full">
            ...
            <form action="#">
                ...
                <div class="text-center">
                    <a href="sign-in.html" class="text-primary-600 font-bold mt-6 hover:underline">Back to Sign In</a>
                </div>

                <div class="mt-10 md:mt-[60px] lg:mt-[100px] xl:mt-[120px] text-center text-sm">
                    <p class="mb-0">Already have an account?  <a href="sign-in.html" class="text-primary-600 font-semibold hover:underline">Sign In</a></p>
                </div>
        ...
        <div class="relative p-10 w-full max-w-[496px] max-h-full rounded-2xl bg-white dark:bg-neutral-700">
            ...
            <div class="p-2.5 text-center">
                <div class="mb-8 inline-flex">
                    <img src="{{ asset('') }}images/auth/envelop-icon.png" alt="">
                </div>
