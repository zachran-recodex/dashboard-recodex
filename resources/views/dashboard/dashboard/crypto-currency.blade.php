<x-dashboard-layout>
    <x-page-header
        ...
        :breadcrumbs="[
            ['label' => 'Crypto Currency', 'route' => route('admin.dashboard.crypto-currency')]
        ]"
    />
                        ...
                        <div class="card-body p-6">
                            ...
                            <div class="flex flex-wrap items-center justify-between gap-2 bg-neutral-200 dark:bg-neutral-600 px-2 py-2 rounded mb-4">
                                <div class="flex flex-wrap items-center justify-between gap-2">
                                    <img src="{{ asset('') }}images/currency/crypto-img1.png" alt="" class="w-9 h-9 rounded-full shrink-0">
                                    <div class="grow">
                            ...
                            <div class="flex flex-wrap items-center justify-between gap-2 bg-neutral-200 dark:bg-neutral-600 px-2 py-2 rounded mb-4">
                                <div class="flex flex-wrap items-center justify-between gap-2">
                                    <img src="{{ asset('') }}images/currency/crypto-img2.png" alt="" class="w-9 h-9 rounded-full shrink-0">
                                    <div class="grow">
                            ...
                            <div class="flex flex-wrap items-center justify-between gap-2 bg-neutral-200 dark:bg-neutral-600 px-2 py-2 rounded mb-4">
                                <div class="flex flex-wrap items-center justify-between gap-2">
                                    <img src="{{ asset('') }}images/currency/crypto-img3.png" alt="" class="w-9 h-9 rounded-full shrink-0">
                                    <div class="grow">
                            ...
                            <div class="flex flex-wrap items-center justify-between gap-2 bg-neutral-200 dark:bg-neutral-600 px-2 py-2 rounded mb-4">
                                <div class="flex flex-wrap items-center justify-between gap-2">
                                    <img src="{{ asset('') }}images/currency/crypto-img4.png" alt="" class="w-9 h-9 rounded-full shrink-0">
                                    <div class="grow">
                            ...
                            <div class="flex flex-wrap items-center justify-between gap-2 bg-neutral-200 dark:bg-neutral-600 px-2 py-2 rounded mb-4">
                                <div class="flex flex-wrap items-center justify-between gap-2">
                                    <img src="{{ asset('') }}images/currency/crypto-img5.png" alt="" class="w-9 h-9 rounded-full shrink-0">
                                    <div class="grow">
                        ...
                        <div>
                            <div class="card-slider">
                                <div class="p-5 h-[240px] rounded-lg overflow-hidden relative z-[1]">
                                    <img src="{{ asset('') }}images/card/card-bg.png" alt="" class="absolute start-0 top-0 w-full h-full object-fit-cover -z-[1]">
                                    <div class="flex flex-col justify-between h-full">
                                        <div class="flex items-center justify-between flex-wrap">
                                            <img src="{{ asset('') }}images/card/card-logo.png" alt="">
                                        </div>
                                        <div>
                    ...
                    <div class="card-body p-6">
                        ...
                        <ul class="flex flex-wrap items-center justify-between mt-4 gap-3">
                            <li class="flex items-center gap-2">
                                ...
                                <span class="text-secondary-light text-sm font-normal">Visits By Day:
                                    <span class="text-neutral-600 dark:text-neutral-200 font-bold">20,000</span>
                                </span>
                            </li>
                            <li class="flex items-center gap-2">
                                <span class="w-3 h-3 rounded-sm bg-warning-600"></span>
                                <span class="text-secondary-light text-sm font-normal">Referral Join:
...
<script src="{{ asset('js/homeFourChart.js') }}"></script>
