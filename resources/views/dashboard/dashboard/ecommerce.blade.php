<x-dashboard-layout>
    <x-page-header
        title="E-Commerce"
        :breadcrumbs="[
            ['label' => 'E-Commerce', 'route' => route('admin.dashboard.ecommerce')]
        ]"
    />
                        ...
                        <div class="card-body p-6">
                            ...
                            <ul class="flex flex-wrap items-center mt-4 gap-3">
                                <li class="flex items-center gap-2">
                                    ...
                                    <span class="text-secondary-light text-sm font-semibold">Earning:
                                ...
                                <li class="flex items-center gap-2">
                                    ...
                                    <span class="text-secondary-light text-sm font-semibold">Expense:
            ...
            <div class="card h-full rounded-lg border-0">
                <div class="card-body p-6">
                    ...
                    <ul class="flex flex-wrap items-center justify-between mt-4 gap-3">
                        <li class="flex items-center gap-2">
                            <span class="w-3 h-3 rounded-sm bg-primary-600"></span>
                            <span class="text-secondary-light text-sm font-normal">Male:
                                <span class="text-neutral-600 dark:text-neutral-200 font-bold">20,000</span>
                            </span>
                        </li>
                        <li class="flex items-center gap-2">
                            <span class="w-3 h-3 rounded-sm bg-warning-600"></span>
                            <span class="text-secondary-light text-sm font-normal">Female:
                    ...
                    <div class="mt-8">
                        <div class="flex items-center justify-between gap-3 mb-5">
                            <div class="flex items-center gap-2">
                                <img src="{{ asset('') }}images/payment/payment1.png" alt="" class="w-10 h-10 rounded-lg shrink-0">
                                <div class="grow">
                        ...
                        <div class="flex items-center justify-between gap-3 mb-5">
                            <div class="flex items-center gap-2">
                                <img src="{{ asset('') }}images/payment/payment2.png" alt="" class="w-10 h-10 rounded-lg shrink-0">
                                <div class="grow">
                        ...
                        <div class="flex items-center justify-between gap-3 mb-5">
                            <div class="flex items-center gap-2">
                                <img src="{{ asset('') }}images/payment/payment3.png" alt="" class="w-10 h-10 rounded-lg shrink-0">
                                <div class="grow">
                        ...
                        <div class="flex items-center justify-between gap-3 mb-5">
                            <div class="flex items-center gap-2">
                                <img src="{{ asset('') }}images/payment/payment4.png" alt="" class="w-10 h-10 rounded-lg shrink-0">
                                <div class="grow">
                ...
                <div class="card-body">
                    ...
                    <div class="mt-8">
                        ...
                        <div class="flex items-center justify-between gap-3 mb-8">
                            <div class="flex items-center gap-2">
                                <img src="{{ asset('') }}images/users/user6.png" alt="" class="w-10 h-10 rounded-lg shrink-0">
                                <div class="grow">
                        ...
                        <div class="flex items-center justify-between gap-3 mb-8">
                            <div class="flex items-center gap-2">
                                <img src="{{ asset('') }}images/users/user1.png" alt="" class="w-10 h-10 rounded-lg shrink-0">
                                <div class="grow">
                        ...
                        <div class="flex items-center justify-between gap-3 mb-8">
                            <div class="flex items-center gap-2">
                                <img src="{{ asset('') }}images/users/user2.png" alt="" class="w-10 h-10 rounded-lg shrink-0">
                                <div class="grow">
                        ...
                        <div class="flex items-center justify-between gap-3 mb-8">
                            <div class="flex items-center gap-2">
                                <img src="{{ asset('') }}images/users/user3.png" alt="" class="w-10 h-10 rounded-lg shrink-0">
                                <div class="grow">
                        ...
                        <div class="flex items-center justify-between gap-3 mb-8">
                            <div class="flex items-center gap-2">
                                <img src="{{ asset('') }}images/users/user4.png" alt="" class="w-10 h-10 rounded-lg shrink-0">
                                <div class="grow">
