<x-dashboard-layout>
    <x-page-header
        title="Investment"
        :breadcrumbs="[
            ['label' => 'Investment', 'route' => route('admin.dashboard.investment')]
        ]"
    />
                    ...
                    <div>
                        ...
                        <div class="flex items-center justify-between gap-3 mb-3 pb-2">
                            <div class="flex items-center w-full">
                                <img src="{{ asset('') }}images/flags/flag1.png" alt="" class="w-10 h-10 rounded-full shrink-0 me-2 overflow-hidden">
                                <div class="grow">
                        ...
                        <div class="flex items-center justify-between gap-3 mb-3 pb-2">
                            <div class="flex items-center w-full">
                                <img src="{{ asset('') }}images/flags/flag2.png" alt="" class="w-10 h-10 rounded-full shrink-0 me-2 overflow-hidden">
                                <div class="grow">
                        ...
                        <div class="flex items-center justify-between gap-3 mb-3 pb-2">
                            <div class="flex items-center w-full">
                                <img src="{{ asset('') }}images/flags/flag3.png" alt="" class="w-10 h-10 rounded-full shrink-0 me-2 overflow-hidden">
                                <div class="grow">
                        ...
                        <div class="flex items-center justify-between gap-3">
                            <div class="flex items-center w-full">
                                <img src="{{ asset('') }}images/flags/flag4.png" alt="" class="w-10 h-10 rounded-full shrink-0 me-2 overflow-hidden">
                                <div class="grow">
                ...
                <div class="card-body p-6">
                    ...
                    <ul class="flex flex-wrap flex-col mt-[64px] gap-3">
                        <li class="flex items-center gap-2">
                            ...
                            <span class="text-secondary-light text-lg font-normal">Total Gain:
                        ...
                        <li class="flex items-center gap-2">
                            ...
                            <span class="text-secondary-light text-lg font-normal">Total Investment:
                    ...
                    <div class="table-responsive scroll-sm">
                        <table class="table bordered-table sm-table mb-0">
                            ...
                            <tr>
                                <td>
                                    <div class="flex items-center">
                                        <img src="{{ asset('') }}images/asset/asset-img1.png" alt="" class="shrink-0 w-10 h-10 rounded-lg me-3">
                                        <div class="grow">
                            ...
                            <tr>
                                <td>
                                    <div class="flex items-center">
                                        <img src="{{ asset('') }}images/asset/asset-img2.png" alt="" class="shrink-0 w-10 h-10 rounded-lg me-3">
                                        <div class="grow">
                            ...
                            <tr>
                                <td>
                                    <div class="flex items-center">
                                        <img src="{{ asset('') }}images/asset/asset-img3.png" alt="" class="shrink-0 w-10 h-10 rounded-lg me-3">
                                        <div class="grow">
                            ...
                            <tr>
                                <td>
                                    <div class="flex items-center">
                                        <img src="{{ asset('') }}images/asset/asset-img4.png" alt="" class="shrink-0 w-10 h-10 rounded-lg me-3">
                                        <div class="grow">
                            ...
                            <tr>
                                <td>
                                    <div class="flex items-center">
                                        <img src="{{ asset('') }}images/asset/asset-img5.png" alt="" class="shrink-0 w-10 h-10 rounded-lg me-3">
                                        <div class="grow">
            ...
            <div class="card h-full border-0">
                <div class="card-body p-6">
                    ...
                    <div class="flex items-start gap-2 mb-5">
                        <img src="{{ asset('') }}images/notice/board-img1.png" alt="" class="shrink-0 w-10 h-10 me-3 rounded-lg">
                        <div class="grow">
                            ...
                            <span class="text-sm text-secondary-light font-normal">25 Jan 2024</span>
                        </div>
                    </div>

                    <div class="flex items-start gap-2 mb-5">
                        <img src="{{ asset('') }}images/notice/board-img2.png" alt="" class="shrink-0 w-10 h-10 me-3 rounded-lg">
                        <div class="grow">
                    ...
                    <div class="flex items-start gap-2">
                        <img src="{{ asset('') }}images/notice/board-img3.png" alt="" class="shrink-0 w-10 h-10 me-3 rounded-lg">
                        <div class="grow">
...
<script src="{{ asset('js/homeFiveChart.js') }}"></script>
