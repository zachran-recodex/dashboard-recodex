<x-dashboard-layout>
    <x-page-header
        ...
        :breadcrumbs="[
            ['label' => 'Learning Management System', 'route' => route('admin.dashboard.lms')]
        ]"
    />
                    ...
                    <div class="col-span-12 md:col-span-6 2xl:col-span-8">
                        <div class="card-body p-0">
                            <div class="flex items-center flex-wrap gap-2 justify-between">
                                <h6 class="mb-2 font-bold text-lg">Average Enrollment Rate
                                </h6>
                                <div class="">
                            ...
                            <ul class="flex flex-wrap items-center justify-center mt-3 gap-3">
                                <li class="flex items-center gap-2">
                                        <span class="w-3 h-3 rounded-full
                                         bg-primary-600"></span>
                                    <span class="text-neutral-600 text-sm font-semibold">Paid Course:
                                ...
                                <li class="flex items-center gap-2">
                                    ...
                                    <span class="text-neutral-600 text-sm font-semibold">Free Course:
                    ...
                    <div class="flex items-center justify-between gap-3 mb-[26px]">
                        <div class="flex items-center gap-3">
                            <div class="w-10 h-10 rounded-lg flex-shrink-0 bg-info-50 dark:bg-info-600/20 flex justify-center items-center">
                                <img src="{{ asset('') }}images/home-six/category-icon1.png" alt="" class="">
                            </div>
                    ...
                    <div class="flex items-center justify-between gap-3 mb-[26px]">
                        <div class="flex items-center gap-3">
                            <div class="w-10 h-10 rounded-lg flex-shrink-0 bg-success-50 dark:bg-success-600/20 flex justify-center items-center">
                                <img src="{{ asset('') }}images/home-six/category-icon2.png" alt="" class="">
                            </div>
                            <div class="flex-grow-1">
                    ...
                    <div class="flex items-center justify-between gap-3 mb-[26px]">
                        <div class="flex items-center gap-3">
                            <div class="w-10 h-10 rounded-lg flex-shrink-0 bg-lilac-50 dark:bg-lilac-600/20 flex justify-center items-center">
                                <img src="{{ asset('') }}images/home-six/category-icon3.png" alt="" class="">
                            </div>
                            <div class="flex-grow-1">
                    ...
                    <div class="flex items-center justify-between gap-3 mb-[26px]">
                        <div class="flex items-center gap-3">
                            <div class="w-10 h-10 rounded-lg flex-shrink-0 bg-warning-50 dark:bg-warning-600/20 flex justify-center items-center">
                                <img src="{{ asset('') }}images/home-six/category-icon4.png" alt="" class="">
                            </div>
                            <div class="flex-grow-1">
                    ...
                    <div class="flex items-center justify-between gap-3 mb-[26px]">
                        <div class="flex items-center gap-3">
                            <div class="w-10 h-10 rounded-lg flex-shrink-0 bg-danger-50 dark:bg-danger-600/20 flex justify-center items-center">
                                <img src="{{ asset('') }}images/home-six/category-icon5.png" alt="" class="">
                            </div>
                            <div class="flex-grow-1">
                    ...
                    <div class="flex items-center justify-between gap-3 mb-0">
                        <div class="flex items-center gap-3">
                            <div class="w-10 h-10 rounded-lg flex-shrink-0 bg-primary-600/10 flex justify-center items-center">
                                <img src="{{ asset('') }}images/home-six/category-icon6.png" alt="" class="">
                            </div>
                            <div class="flex-grow-1">
                ...
                <div class="card-body">
                    <div class="flex items-center justify-between gap-3 mb-6">
                        <div class="flex items-center">
                            <img src="{{ asset('') }}images/users/user1.png" alt="" class="w-10 h-10 rounded-full
                    ...
                    <div class="flex items-center justify-between gap-3 mb-6">
                        <div class="flex items-center">
                            <img src="{{ asset('') }}images/users/user2.png" alt="" class="w-10 h-10 rounded-full
                                 flex-shrink-0 me-3 overflow-hidden">
                            <div class="flex-grow-1">
                    ...
                    <div class="flex items-center justify-between gap-3 mb-6">
                        <div class="flex items-center">
                            <img src="{{ asset('') }}images/users/user3.png" alt="" class="w-10 h-10 rounded-full
                                 flex-shrink-0 me-3 overflow-hidden">
                            <div class="flex-grow-1">
                    ...
                    <div class="flex items-center justify-between gap-3 mb-6">
                        <div class="flex items-center">
                            <img src="{{ asset('') }}images/users/user4.png" alt="" class="w-10 h-10 rounded-full
                                 flex-shrink-0 me-3 overflow-hidden">
                            <div class="flex-grow-1">
                    ...
                    <div class="flex items-center justify-between gap-3 mb-6">
                        <div class="flex items-center">
                            <img src="{{ asset('') }}images/users/user5.png" alt="" class="w-10 h-10 rounded-full
                                 flex-shrink-0 me-3 overflow-hidden">
                            <div class="flex-grow-1">
        ...
        <div class="col-span-12 md:col-span-6 2xl:col-span-4">
            <div class="card border-0 h-full">
                ...
                <div class="card-body">
                    <div class="flex items-center justify-between gap-3 mb-6">
                        <div class="flex items-center">
                            <img src="{{ asset('') }}images/home-six/student-img1.png" alt="" class="w-10 h-10 rounded-lg flex-shrink-0 me-3 overflow-hidden">
                            <div class="flex-grow-1">
                    ...
                    <div class="flex items-center justify-between gap-3 mb-6">
                        <div class="flex items-center">
                            <img src="{{ asset('') }}images/home-six/student-img2.png" alt="" class="w-10 h-10 rounded-lg flex-shrink-0 me-3 overflow-hidden">
                            <div class="flex-grow-1">
                    ...
                    <div class="flex items-center justify-between gap-3 mb-6">
                        <div class="flex items-center">
                            <img src="{{ asset('') }}images/home-six/student-img3.png" alt="" class="w-10 h-10 rounded-lg flex-shrink-0 me-3 overflow-hidden">
                            <div class="flex-grow-1">
                    ...
                    <div class="flex items-center justify-between gap-3 mb-6">
                        <div class="flex items-center">
                            <img src="{{ asset('') }}images/home-six/student-img4.png" alt="" class="w-10 h-10 rounded-lg flex-shrink-0 me-3 overflow-hidden">
                            <div class="flex-grow-1">
                    ...
                    <div class="flex items-center justify-between gap-3 mb-6">
                        <div class="flex items-center">
                            <img src="{{ asset('') }}images/home-six/student-img5.png" alt="" class="w-10 h-10 rounded-lg flex-shrink-0 me-3 overflow-hidden">
                            <div class="flex-grow-1">
                    ...
                    <div class="flex items-center justify-between gap-3 mb-0">
                        <div class="flex items-center">
                            <img src="{{ asset('') }}images/home-six/student-img6.png" alt="" class="w-10 h-10 rounded-lg flex-shrink-0 me-3 overflow-hidden">
                            <div class="flex-grow-1">
                ...
                <div class="card-body p-6">
                    <div class="table-responsive scroll-sm">
                        <table class="table bordered-table mb-0">
                            ...
                            <tr>
                                <td>
                                    <span class="text-neutral-600">24 Jun 2024</span>
                                </td>
                                <td>
