<x-dashboard-layout>
    <x-page-header
        title="NFT & Gaming"
        :breadcrumbs="[
            ['label' => 'NFT & Gaming', 'route' => route('admin.dashboard.nft')]
        ]"
    />
            ...
            <div class="gap-6 grid grid-cols-1 sm:grid-cols-12">
                <div class="col-span-12">
                    <div class="nft-promo-card card border-0 rounded-xl overflow-hidden relative z-1 py-6 3xl:px-[76px] 2xl:px-[56px] xl:px-[40px] lg:px-[28px] px-4">
                        <img src="{{ asset('') }}images/nft/nft-gradient-bg.png" class="absolute start-0 top-0 w-full h-full z-[1]" alt="">
                        <div class="nft-promo-card__inner flex 3xl:gap-[80px] 2xl:gap-[48px] xl:gap-[32px] lg:gap-6 gap-4 items-center relative z-[1]">
                            <div class="nft-promo-card__thumb w-full">
                                <img src="{{ asset('') }}images/nft/nf-card-img.png" alt="" class="w-full h-full object-fit-cover">
                            </div>
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 2xl:grid-cols-4 gap-6">
                                <div class="nft-card bg-white dark:bg-neutral-700 rounded overflow-hidden">
                                    <div class="rounded overflow-hidden">
                                        <img src="{{ asset('') }}images/nft/nft-img1.png" alt="" class="w-full h-full object-fit-cover">
                                    </div>
                                    <div class="p-2.5">
                                        <h6 class="text-base font-bold text-primary-light">Fantastic Alien</h6>
                                        <div class="flex items-center gap-2">
                                            <img src="{{ asset('') }}images/nft/nft-user-img1.png" class="w-28-px h-28-px rounded-full object-fit-cover" alt="">
                                        ...
                                        <div class="mt-2.5 flex items-center justify-between gap-2 flex-wrap">
                                            <span class="text-sm text-secondary-light font-medium">Price:
                                ...
                                <div class="nft-card bg-white dark:bg-neutral-700 rounded overflow-hidden">
                                    <div class="rounded overflow-hidden">
                                        <img src="{{ asset('') }}images/nft/nft-img2.png" alt="" class="w-full h-full object-fit-cover">
                                    </div>
                                    <div class="p-2.5">
                                        <h6 class="text-base font-bold text-primary-light">New Figures</h6>
                                        <div class="flex items-center gap-2">
                                            <img src="{{ asset('') }}images/nft/nft-user-img2.png" class="w-28-px h-28-px rounded-full object-fit-cover" alt="">
                                            <span class="text-sm text-secondary-light font-medium">Watson Kristin</span>
                                        </div>
                                        <div class="mt-2.5 flex items-center justify-between gap-2 flex-wrap">
                                            <span class="text-sm text-secondary-light font-medium">Price:
                                ...
                                <div class="nft-card bg-white dark:bg-neutral-700 rounded overflow-hidden">
                                    <div class="rounded overflow-hidden">
                                        <img src="{{ asset('') }}images/nft/nft-img3.png" alt="" class="w-full h-full object-fit-cover">
                                    </div>
                                    <div class="p-2.5">
                                        <h6 class="text-base font-bold text-primary-light">New Figures</h6>
                                        <div class="flex items-center gap-2">
                                            <img src="{{ asset('') }}images/nft/nft-user-img3.png" class="w-28-px h-28-px rounded-full object-fit-cover" alt="">
                                            <span class="text-sm text-secondary-light font-medium">Watson Kristin</span>
                                        </div>
                                        <div class="mt-2.5 flex items-center justify-between gap-2 flex-wrap">
                                            <span class="text-sm text-secondary-light font-medium">Price:
                                ...
                                <div class="nft-card bg-white dark:bg-neutral-700 rounded overflow-hidden">
                                    <div class="rounded overflow-hidden">
                                        <img src="{{ asset('') }}images/nft/nft-img4.png" alt="" class="w-full h-full object-fit-cover">
                                    </div>
                                    <div class="p-2.5">
                                        <h6 class="text-base font-bold text-primary-light">New Figures</h6>
                                        <div class="flex items-center gap-2">
                                            <img src="{{ asset('') }}images/nft/nft-user-img4.png" class="w-28-px h-28-px rounded-full object-fit-cover" alt="">
                                            <span class="text-sm text-secondary-light font-medium">Watson Kristin</span>
                                        </div>
                                        <div class="mt-2.5 flex items-center justify-between gap-2 flex-wrap">
                                            <span class="text-sm text-secondary-light font-medium">Price:
                                ...
                                <div class="table-responsive scroll-sm">
                                    <table class="table bordered-table sm-table mb-0">
                                        ...
                                        <tr>
                                            <td>
                                                <div class="flex items-center">
                                                    <img src="{{ asset('') }}images/nft/nft-items-img1.png" alt="" class="flex-shrink-0 w-10 h-10 rounded-full me-3">
                                                    <div class="flex-grow-1">
                                            ...
                                            <td>
                                                <div class="flex items-center">
                                                    <img src="{{ asset('') }}images/nft/nft-offer-img1.png" alt="" class="flex-shrink-0 w-10 h-10 rounded-full me-3">
                                                    <div class="flex-grow-1">
                                        ...
                                        <tr>
                                            <td>
                                                <div class="flex items-center">
                                                    <img src="{{ asset('') }}images/nft/nft-items-img2.png" alt="" class="flex-shrink-0 w-10 h-10 rounded-full me-3">
                                                    <div class="flex-grow-1">
                                            ...
                                            <td>
                                                <div class="flex items-center">
                                                    <img src="{{ asset('') }}images/nft/nft-offer-img2.png" alt="" class="flex-shrink-0 w-10 h-10 rounded-full me-3">
                                                    <div class="flex-grow-1">
                                                        <h6 class="text-base mb-0 font-semibold text-primary-light">1.44.00 ETH</h6>
                                                    </div>
                                                </div>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="flex items-center">
                                                    <img src="{{ asset('') }}images/nft/nft-items-img3.png" alt="" class="flex-shrink-0 w-10 h-10 rounded-full me-3">
                                                    <div class="flex-grow-1">
                                            ...
                                            <td>
                                                <div class="flex items-center">
                                                    <img src="{{ asset('') }}images/nft/nft-offer-img3.png" alt="" class="flex-shrink-0 w-10 h-10 rounded-full me-3">
                                                    <div class="flex-grow-1">
                                                        <h6 class="text-base mb-0 font-semibold text-primary-light">1.44.00 ETH</h6>
                                                    </div>
                                                </div>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="flex items-center">
                                                    <img src="{{ asset('') }}images/nft/nft-items-img4.png" alt="" class="flex-shrink-0 w-10 h-10 rounded-full me-3">
                                                    <div class="flex-grow-1">
                                            ...
                                            <td>
                                                <div class="flex items-center">
                                                    <img src="{{ asset('') }}images/nft/nft-offer-img4.png" alt="" class="flex-shrink-0 w-10 h-10 rounded-full me-3">
                                                    <div class="flex-grow-1">
                                                        <h6 class="text-base mb-0 font-semibold text-primary-light">1.44.00 ETH</h6>
                                                    </div>
                                                </div>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="flex items-center">
                                                    <img src="{{ asset('') }}images/nft/nft-items-img5.png" alt="" class="flex-shrink-0 w-10 h-10 rounded-full me-3">
                                                    <div class="flex-grow-1">
                                            ...
                                            <td>
                                                <div class="flex items-center">
                                                    <img src="{{ asset('') }}images/nft/nft-offer-img5.png" alt="" class="flex-shrink-0 w-10 h-10 rounded-full me-3">
                                                    <div class="flex-grow-1">
                                                        <h6 class="text-base mb-0 font-semibold text-primary-light">1.44.00 ETH</h6>
                                                    </div>
                                                </div>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="flex items-center">
                                                    <img src="{{ asset('') }}images/nft/nft-items-img6.png" alt="" class="flex-shrink-0 w-10 h-10 rounded-full me-3">
                                                    <div class="flex-grow-1">
                                                        <h6 class="text-base mb-0 font-semibold">Hoodie Rose</h6>
                                                        <span class="text-sm text-secondary-light font-normal">Owned by ABC</span>
                                                    </div>
                                            ...
                                            <td>
                                                <div class="flex items-center">
                                                    <img src="{{ asset('') }}images/nft/nft-offer-img6.png" alt="" class="flex-shrink-0 w-10 h-10 rounded-full me-3">
                                                    <div class="flex-grow-1">
                                                        <h6 class="text-base mb-0 font-semibold text-primary-light">1.44.00 ETH</h6>
                                                    </div>
                                                </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="flex items-center">
                                                    <img src="{{ asset('') }}images/nft/nft-offer-img7.png" alt="" class="flex-shrink-0 w-10 h-10 rounded-full me-3">
                                                    <div class="flex-grow-1">
                                                        <h6 class="text-base mb-0 font-semibold text-primary-light">1.44.00 ETH</h6>
                                                    </div>
                                                </div>
                            ...
                            <div class="mt-6">
                                <div class="grid grid-cols-2 gap-6">
                                    <div class="nft-card bg-white dark:bg-neutral-700 rounded overflow-hidden shadow-4">
                                        <div class="rounded overflow-hidden">
                                            <img src="{{ asset('') }}images/nft/featured-creator1.png" alt="" class="w-full h-full object-fit-cover">
                                        </div>
                                        <div class="p-3">
                                            <h6 class="text-base font-bold text-primary-light mb-3">New Figures</h6>
                                            <div class="flex items-center gap-2">
                                                <img src="{{ asset('') }}images/nft/bitcoin.png" class="w-28-px h-28-px rounded-full object-fit-cover" alt="">
                                    ...
                                    <div class="nft-card bg-white dark:bg-neutral-700 rounded overflow-hidden shadow-4">
                                        <div class="rounded overflow-hidden">
                                            <img src="{{ asset('') }}images/nft/featured-creator2.png" alt="" class="w-full h-full object-fit-cover">
                                        </div>
                                        <div class="p-3">
                    ...
                    <div class="card border-0 h-full">
                        ...
                        <div class="card-body pt-6">
                            <div class="flex items-center justify-between gap-2 flex-wrap mb-[32px]">
                                <div class="flex items-center">
                                    <img src="{{ asset('') }}images/nft/creator-img1.png" alt="" class="flex-shrink-0 w-10 h-10 rounded-full me-3">
                                    <div class="flex-grow-1">
                                        <h6 class="text-base mb-0 font-semibold">Theresa Webb</h6>
                            ...
                            <div class="flex items-center justify-between gap-2 flex-wrap mb-[32px]">
                                <div class="flex items-center">
                                    <img src="{{ asset('') }}images/nft/creator-img2.png" alt="" class="flex-shrink-0 w-10 h-10 rounded-full me-3">
                                    <div class="flex-grow-1">
                            ...
                            <div class="flex items-center justify-between gap-2 flex-wrap mb-[32px]">
                                <div class="flex items-center">
                                    <img src="{{ asset('') }}images/nft/creator-img3.png" alt="" class="flex-shrink-0 w-10 h-10 rounded-full me-3">
                                    <div class="flex-grow-1">
                            ...
                            <div class="flex items-center justify-between gap-2 flex-wrap mb-[32px]">
                                <div class="flex items-center">
                                    <img src="{{ asset('') }}images/nft/creator-img4.png" alt="" class="flex-shrink-0 w-10 h-10 rounded-full me-3">
                                    <div class="flex-grow-1">
                            ...
                            <div class="flex items-center justify-between gap-2 flex-wrap mb-0">
                                <div class="flex items-center">
                                    <img src="{{ asset('') }}images/nft/creator-img5.png" alt="" class="flex-shrink-0 w-10 h-10 rounded-full me-3">
                                    <div class="flex-grow-1">
