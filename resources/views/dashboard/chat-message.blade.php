            ...
            <div class="chat-all-list flex flex-col gap-1.5 mt-3 max-h-[580px] overflow-y-auto">
                <a href="javascript:void(0)" class="flex items-center justify-between gap-2 cursor-pointer hover:bg-neutral-50 dark:hover:bg-neutral-600 px-6 py-2.5 active">
                    <div class="flex items-center gap-2">
                        <div class="img">
                            <img src="{{ asset('') }}images/chat/2.png" alt="image">
                        </div>
                        <div class="info">
                ...
                <a href="javascript:void(0)" class="flex items-center justify-between gap-2 cursor-pointer hover:bg-neutral-50 dark:hover:bg-neutral-600 px-6 py-2.5 active">
                    <div class="flex items-center gap-2">
                        <div class="img">
                            <img src="{{ asset('') }}images/chat/3.png" alt="image">
                        </div>
                        <div class="info">
                ...
                <a href="javascript:void(0)" class="flex items-center justify-between gap-2 cursor-pointer hover:bg-neutral-50 dark:hover:bg-neutral-600 px-6 py-2.5">
                    <div class="flex items-center gap-2">
                        <div class="img">
                            <img src="{{ asset('') }}images/chat/4.png" alt="image">
                        </div>
                        <div class="info">
                ...
                <a href="javascript:void(0)" class="flex items-center justify-between gap-2 cursor-pointer hover:bg-neutral-50 dark:hover:bg-neutral-600 px-6 py-2.5">
                    <div class="flex items-center gap-2">
                        <div class="img">
                            <img src="{{ asset('') }}images/chat/5.png" alt="image">
                        </div>
                        <div class="info">
                ...
                <a href="javascript:void(0)" class="flex items-center justify-between gap-2 cursor-pointer hover:bg-neutral-50 dark:hover:bg-neutral-600 px-6 py-2.5 active">
                    <div class="flex items-center gap-2">
                        <div class="img">
                            <img src="{{ asset('') }}images/chat/6.png" alt="image">
                        </div>
                        <div class="info">
                ...
                <a href="javascript:void(0)" class="flex items-center justify-between gap-2 cursor-pointer hover:bg-neutral-50 dark:hover:bg-neutral-600 px-6 py-2.5 active">
                    <div class="flex items-center gap-2">
                        <div class="img">
                            <img src="{{ asset('') }}images/chat/7.png" alt="image">
                        </div>
                        <div class="info">
                ...
                <a href="javascript:void(0)" class="flex items-center justify-between gap-2 cursor-pointer hover:bg-neutral-50 dark:hover:bg-neutral-600 px-6 py-2.5 active">
                    <div class="flex items-center gap-2">
                        <div class="img">
                            <img src="{{ asset('') }}images/chat/8.png" alt="image">
                        </div>
                        <div class="info">
                ...
                <a href="javascript:void(0)" class="flex items-center justify-between gap-2 cursor-pointer hover:bg-neutral-50 dark:hover:bg-neutral-600 px-6 py-2.5 active">
                    <div class="flex items-center gap-2">
                        <div class="img">
                            <img src="{{ asset('') }}images/chat/9.png" alt="image">
                        </div>
                        <div class="info">
                ...
                <a href="javascript:void(0)" class="flex items-center justify-between gap-2 cursor-pointer hover:bg-neutral-50 dark:hover:bg-neutral-600 px-6 py-2.5 active">
                    <div class="flex items-center gap-2">
                        <div class="img">
                            <img src="{{ asset('') }}images/chat/10.png" alt="image">
                        </div>
                        <div class="info">
        ...
        <div class=" col-span-12 md:col-span-8 xl:col-span-9">
            <div class="card border-0 overflow-hidden flex flex-col">
                <div class="flex items-center justify-between gap-2  px-6 py-2.5 active border-b border-neutral-200 dark:border-neutral-600">
                    <div class="flex items-center gap-2">
                        <div class="img">
                            <img src="{{ asset('') }}images/chat/11.png" alt="image">
                        </div>
                        <div class="info">
                            <h6 class="text-base mb-0">Kathryn Murphy</h6>
                            <p class="mb-0">Available</p>
                ...
                <div class="chat-message-list max-h-[568px] overflow-y-auto flex flex-col p-6 gap-6">
                    <div class="max-w-[700px] text-neutral-900 flex items-end gap-3">
                        <img src="{{ asset('') }}images/chat/11.png" alt="image" class="avatar-lg object-fit-cover rounded-full">
