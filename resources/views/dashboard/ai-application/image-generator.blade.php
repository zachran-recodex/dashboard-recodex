                        ...
                        <div class="card-body p-0">
                            ...
                            <div class="py-4 px-6 flex items-start justify-between gap-4 border-b border-neutral-200 dark:border-neutral-600 pb-4 mb-4">
                                <div class="flex items-center gap-4">
                                    <div class="img overflow-hidden shrink-0">
                                        <img src="{{ asset('') }}images/chat/1.png" alt="image" class="w-[44px] h-[44px] rounded-full object-fit-cover">
                                    </div>
                                    <div class="info grow">
                            ...
                            <div class="py-4 px-6 border-b border-neutral-200 dark:border-neutral-600">
                                <div class="flex items-start gap-4 border-b border-neutral-200 dark:border-neutral-600 pb-4 mb-4">
                                    <div class="img overflow-hidden shrink-0">
                                        <img src="{{ asset('') }}images/wow-dash-favicon.png" alt="image" class="w-[44px] h-[44px] rounded-full object-fit-cover">
                                    </div>
                                    <div class="info grow">
                                        ...
                                        <div class="grid sm:grid-cols-12 gap-6">
                                            <div class="col-span-12 sm:col-span-6 xl:col-span-3">
                                                <div class="generated-image-item rounded-lg overflow-hidden relative">
                                                    <img src="{{ asset('') }}images/chatgpt/image-generator1.png" alt="" class="w-full h-full object-fit-cover">
                                            ...
                                            <div class="col-span-12 sm:col-span-6 xl:col-span-3">
                                                <div class="generated-image-item rounded-lg overflow-hidden relative">
                                                    <img src="{{ asset('') }}images/chatgpt/image-generator2.png" alt="" class="w-full h-full object-fit-cover">
                                                    <div class="form-check style-check flex items-center absolute top-0 start-0 ms-8 mt-2">
                                            ...
                                            <div class="col-span-12 sm:col-span-6 xl:col-span-3">
                                                <div class="generated-image-item rounded-lg overflow-hidden relative">
                                                    <img src="{{ asset('') }}images/chatgpt/image-generator3.png" alt="" class="w-full h-full object-fit-cover">
                                                    <div class="form-check style-check flex items-center absolute top-0 start-0 ms-8 mt-2">
                                            ...
                                            <div class="col-span-12 sm:col-span-6 xl:col-span-3">
                                                <div class="generated-image-item rounded-lg overflow-hidden relative">
                                                    <img src="{{ asset('') }}images/chatgpt/image-generator4.png" alt="" class="w-full h-full object-fit-cover">
                                                    <div class="form-check style-check flex items-center absolute top-0 start-0 ms-8 mt-2">
                                        ...
                                        <div class="grid sm:grid-cols-12 gap-6">
                                            <div class="col-span-12 sm:col-span-6">
                                                <div class="generated-image-item radius-8 overflow-hidden relative">
                                                    <img src="{{ asset('') }}images/chatgpt/image-generator5.png" alt="" class="w-100 h-100 object-fit-cover">
