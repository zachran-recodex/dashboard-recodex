                    ...
                    <div class="mb-5">
                        ...
                        <div class="avatar-upload mt-4">
                            <div class="avatar-preview">
                                <div id="previewImage1" class=" w-[120px] h-[120px] rounded-lg border border-neutral-300 bg-center bg-no-repeat bg-cover" style="background-image: url('{{ asset('') }}images/payment/upload-image.png');"></div>
                            </div>
                        </div>
                    </div>
                    <div class="mb-5">
                        ...
                        <div class="avatar-upload mt-4">
                            <div class="avatar-preview">
                                <div id="previewImage2" class=" w-[120px] h-[120px] rounded-lg border border-neutral-300 bg-center bg-no-repeat bg-cover" style="background-image: url('{{ asset('') }}images/payment/upload-image.png');"></div>
                            </div>
                        </div>
                    </div>
                </div>
...
<script>
        ...
        if (input.files && input.files[0]) {
            ...
            reader.onload = function(e) {
                ...
                setTimeout(function() {
                    ...
                    previewElement.style.transition = 'opacity 0.65s';
    ...
    document.getElementById("imageUploadTwo").addEventListener("change", function() {
