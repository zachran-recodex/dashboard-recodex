            ...
            <div class="card-body p-6">
                <div class="upload-image-wrapper flex items-center gap-3">
                    <div class="uploaded-img hidden relative h-[120px] w-[120px] border input-form-light rounded-lg overflow-hidden border-dashed bg-neutral-50 dark:bg-neutral-600">
                        ...
                        <img id="uploaded-img__preview" class="w-full h-full object-fit-cover" src="{{ asset('') }}images/user.png" alt="image">
                    </div>
...
<script>
    ...
    fileInputMultiple.addEventListener("change", (e) => {
        ...
        Array.from(files).forEach(file => {
            ...
            imgContainer.classList.add('relative', 'h-[120px]', 'w-[120px]', 'border', 'input-form-light', 'rounded-lg', 'overflow-hidden', 'border-dashed', 'bg-neutral-50', 'dark:bg-neutral-600');

            const removeButton = document.createElement('button');
            removeButton.type = 'button';
            removeButton.classList.add('uploaded-img__remove', 'absolute', 'top-0', 'right-0', 'z-1', 'text-2xl', 'line-height-1', 'm-2', 'flex');
            ...
            // Event listener to remove the image
            removeButton.addEventListener('click', () => {
    ...
    document.getElementById('file-upload-name').addEventListener('change', function(event) {
        ...
        for (var i = 0; i < fileList.length; i++) {
            ...
            li.classList.add('uploaded-image-name-list', 'text-primary-600', 'font-semibold', 'flex', 'items-center', 'gap-2');
