        ...
        <div class="card h-full p-0 border-0 overflow-hidden">
            ...
            <div class="card-body p-6">
                <div class="flex flex-wrap items-center gap-3">
                    ...
                    <!-- Dropdown Start -->
                    <div class="">
                        <button data-dropdown-toggle="defaultActionPill" data-dropdown-placement="bottom" class="text-white bg-primary-600 hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-base px-5 py-4 text-center inline-flex items-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800" type="button">Default Action
        ...
        <div class="card h-full p-0 border-0 overflow-hidden">
            ...
            <div class="card-body p-6">
                <div class="flex flex-wrap items-center gap-3">
                    ...
                    <!-- Dropdown Start -->
                    <div class="">
                        <button data-dropdown-toggle="defaultActionPillDroppop" data-dropdown-placement="top" class="text-white bg-primary-600 hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-base px-5 py-4 text-center inline-flex items-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800" type="button">Default Action
                            <svg class="w-2.5 h-2.5 ms-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
        ...
        <div class="card h-full p-0 border-0 overflow-hidden">
            ...
            <div class="card-body p-6">
                <div class="flex flex-wrap items-center gap-3">
                    ...
                    <!-- Dropdown Start -->
                    <div class="">
                        <button data-dropdown-toggle="defaultActionPillDropRight" data-dropdown-placement="right" class="text-white bg-warning-600 hover:bg-warning-700 focus:ring-4 focus:outline-none focus:ring-warning-300 font-medium rounded-lg text-base px-5 py-4 text-center inline-flex items-center dark:bg-warning-600 dark:hover:bg-warning-700 dark:focus:ring-warning-800" type="button">Default Action
        ...
        <div class="card h-full p-0 border-0 overflow-hidden">
            ...
            <div class="card-body p-6">
                <div class="flex flex-wrap items-center gap-3">
                    ...
                    <!-- Dropdown Start -->
                    <div class="">
                        <button data-dropdown-toggle="defaultActionPilltwoo" data-dropdown-placement="bottom" class="text-white bg-primary-600 hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-base px-5 py-3 text-center inline-flex items-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800" type="button">Default Action
                            <svg class="w-2.5 h-2.5 ms-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
                                <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 4 4 4-4"/>
                            </svg>
                        </button>
                    ...
                    <!-- Dropdown Start -->
                    <div class="">
                        <button data-dropdown-toggle="defaultActionPillThreee" data-dropdown-placement="bottom" class="text-white bg-primary-600 hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-base px-5 py-2 text-center inline-flex items-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800" type="button">Default Action
                            <svg class="w-2.5 h-2.5 ms-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
                                <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 4 4 4-4"/>
                            </svg>
                        </button>
