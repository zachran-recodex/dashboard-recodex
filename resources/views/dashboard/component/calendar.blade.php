                ...
                <form action="#">
                    <div class="grid grid-cols-1 md:grid-cols-12 gap-6">
                        ...
                        <div class="col-span-12 md:col-span-6 mb-5">
                            ...
                            <div class=" relative">
                                <input class="form-control rounded-lg bg-white dark:bg-neutral-700" id="startDate" type="text" placeholder="03/12/2024, 10:30 AM">
                        ...
                        <div class="col-span-12 md:col-span-6 mb-5">
                            ...
                            <div class=" relative">
                                <input class="form-control rounded-lg bg-white dark:bg-neutral-700" id="endDate" type="text" placeholder="03/12/2024, 2:30 PM">
                                <span class="absolute end-0 top-1/2 -translate-y-1/2 me-3 line-height-1"><iconify-icon icon="solar:calendar-linear" class="icon text-lg"></iconify-icon></span>
                            </div>
                        </div>
                        <div class="col-span-12 mb-5">
        ...
        <div class="rounded-2xl bg-white dark:bg-neutral-700 max-w-[600px] w-full">
            ...
            <div class="p-6">
                ...
                <div class="mb-3">
                    ...
                    <h6 class="text-neutral-600 dark:text-neutral-200 font-semibold text-base mb-0 mt-6">25 Jan 2024, 10:30AM</h6>
                </div>
                <div class="mb-3">
                    <span class="text-secondary-light txt-sm font-medium">End Date</span>
                    <h6 class="text-neutral-600 dark:text-neutral-200 font-semibold text-base mb-0 mt-6">25 Jan 2024, 2:30AM</h6>
                </div>
                <div class="mb-3">
                ...
                <form action="#">
                    <div class="grid grid-cols-1 md:grid-cols-12 gap-6">
                        ...
                        <div class="col-span-12 md:col-span-6 mb-5">
                            ...
                            <div class=" relative">
                                <input class="form-control rounded-lg bg-white dark:bg-neutral-700" id="editstartDate" type="text" placeholder="03/12/2024, 10:30 AM">
                                <span class="absolute end-0 top-1/2 -translate-y-1/2 me-3 line-height-1"><iconify-icon icon="solar:calendar-linear" class="icon text-lg"></iconify-icon></span>
                            </div>
                        </div>
                        <div class="col-span-12 md:col-span-6 mb-5">
                            ...
                            <div class=" relative">
                                <input class="form-control rounded-lg bg-white dark:bg-neutral-700" id="editendDate" type="text" placeholder="03/12/2024, 2:30 PM">
                                <span class="absolute end-0 top-1/2 -translate-y-1/2 me-3 line-height-1"><iconify-icon icon="solar:calendar-linear" class="icon text-lg"></iconify-icon></span>
                            </div>
                        </div>
                        <div class="col-span-12 mb-5">
