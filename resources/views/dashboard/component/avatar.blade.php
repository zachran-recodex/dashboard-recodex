            ...
            <div class="card p-0 overflow-hidden relative rounded-xl border-0">
                ...
                <div class="card-body p-6">
                    <div class="flex items-center flex-wrap gap-3">
                        <img src="{{ asset('') }}images/avatar/avatar1.png" class="w-6 h-6 rounded-full object-fit-cover" alt="Avatar">
                        <img src="{{ asset('') }}images/avatar/avatar1.png" class="w-8 h-8 rounded-full object-fit-cover" alt="Avatar">
                        <img src="{{ asset('') }}images/avatar/avatar1.png" class="w-10 h-10 rounded-full object-fit-cover" alt="Avatar">
                        <img src="{{ asset('') }}images/avatar/avatar1.png" class="w-[44px] h-[44px] rounded-full object-fit-cover" alt="Avatar">
                        <img src="{{ asset('') }}images/avatar/avatar1.png" class="w-[56px] h-[56px] rounded-full object-fit-cover" alt="Avatar">
                        <img src="{{ asset('') }}images/avatar/avatar1.png" class="w-[64px] h-[64px] rounded-full object-fit-cover" alt="Avatar">
                        <img src="{{ asset('') }}images/avatar/avatar1.png" class="w-[72px] h-[72px] rounded-full object-fit-cover" alt="Avatar">
                        <img src="{{ asset('') }}images/avatar/avatar1.png" class="w-[80px] h-[80px] rounded-full object-fit-cover" alt="Avatar">
                    </div>
                    <div class="flex items-center flex-wrap gap-3 mt-6">
                        <img src="{{ asset('') }}images/avatar/avatar2.png" class="w-6 h-6 rounded-lg object-fit-cover" alt="Avatar">
                        <img src="{{ asset('') }}images/avatar/avatar2.png" class="w-8 h-8 rounded-lg object-fit-cover" alt="Avatar">
                        <img src="{{ asset('') }}images/avatar/avatar2.png" class="w-10 h-10 rounded-lg object-fit-cover" alt="Avatar">
                        <img src="{{ asset('') }}images/avatar/avatar2.png" class="w-[44px] h-[44px] rounded-lg object-fit-cover" alt="Avatar">
                        <img src="{{ asset('') }}images/avatar/avatar2.png" class="w-[56px] h-[56px] rounded-lg object-fit-cover" alt="Avatar">
                        <img src="{{ asset('') }}images/avatar/avatar2.png" class="w-[64px] h-[64px] rounded-lg object-fit-cover" alt="Avatar">
                        <img src="{{ asset('') }}images/avatar/avatar2.png" class="w-[72px] h-[72px] rounded-lg object-fit-cover" alt="Avatar">
                        <img src="{{ asset('') }}images/avatar/avatar2.png" class="w-[80px] h-[80px] rounded-lg object-fit-cover" alt="Avatar">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card p-0 overflow-hidden relative rounded-xl border-0">
                ...
                <div class="card-body p-6">
                    <div class="flex items-center flex-wrap justify-between gap-3">
                        <img src="{{ asset('') }}images/avatar/avatar-shape1.png" alt="" class="w-[120px] h-[120px] rounded-lg object-fit-cover">
                        <img src="{{ asset('') }}images/avatar/avatar-shape2.png" alt="" class="w-[120px] h-[120px] rounded-full object-fit-cover">
                        <img src="{{ asset('') }}images/avatar/avatar-shape3.png" alt="" class="w-auto h-[120px]  object-fit-cover">
                    </div>
                </div>
            </div>
        </div>
        <div class="col-span-12 md:col-span-6">
            <div class="card p-0 overflow-hidden relative rounded-xl border-0 h-full">
                ...
                <div class="card-body p-6">
                    <div class="flex items-center flex-wrap gap-3">
                        <div class="relative">
                            <img src="{{ asset('') }}images/avatar/status-avatar.png" class="w-6 h-6 rounded-full object-fit-cover" alt="Avatar">
                            <span class="w-2 h-2 bg-primary-600 border br-white rounded-full absolute end-0 bottom-[3px]"></span>
                        </div>
                        <div class="relative">
                            <img src="{{ asset('') }}images/avatar/status-avatar.png" class="w-8 h-8 rounded-full object-fit-cover" alt="Avatar">
                            <span class="w-2 h-2 bg-primary-600 border br-white rounded-full absolute end-0 bottom-[3px]"></span>
                        </div>
                        <div class="relative">
                            <img src="{{ asset('') }}images/avatar/status-avatar.png" class="w-10 h-10 rounded-full object-fit-cover" alt="Avatar">
                            <span class="w-2 h-2 bg-primary-600 border br-white rounded-full absolute end-0 bottom-[3px]"></span>
                        </div>
                        <div class="relative">
                            <img src="{{ asset('') }}images/avatar/status-avatar.png" class="w-[44px] h-[44px] rounded-full object-fit-cover" alt="Avatar">
                            <span class="w-2 h-2 bg-primary-600 border br-white rounded-full absolute end-0 bottom-[3px]"></span>
                        </div>
                    </div>
                    <div class="flex items-center flex-wrap gap-3 mt-6">
            ...
            <div class="card p-0 overflow-hidden relative rounded-xl border-0 h-full">
                ...
                <div class="card-body p-6">
                    <div class="flex -space-x-2 overflow-hidden">
                        <img src="{{ asset('') }}images/avatar/avatar-group1.png" alt="" class="w-6 h-6 rounded-full object-fit-cover relative">
                        <img src="{{ asset('') }}images/avatar/avatar-group2.png" alt="" class="w-6 h-6 rounded-full object-fit-cover relative ms--10px">
                        <img src="{{ asset('') }}images/avatar/avatar-group3.png" alt="" class="w-6 h-6 rounded-full object-fit-cover relative ms--10px">
                        <img src="{{ asset('') }}images/avatar/avatar-group4.png" alt="" class="w-6 h-6 rounded-full object-fit-cover relative ms--10px">
                        <img src="{{ asset('') }}images/avatar/avatar-group5.png" alt="" class="w-6 h-6 rounded-full object-fit-cover relative ms--10px">
                        <img src="{{ asset('') }}images/avatar/avatar-group6.png" alt="" class="w-6 h-6 rounded-full object-fit-cover relative ms--10px">
                        <img src="{{ asset('') }}images/avatar/avatar-group6.png" alt="" class="w-6 h-6 rounded-full object-fit-cover relative ms--10px">
                    ...
                    <div class="flex -space-x-2 overflow-hidden mt-6">
                        <img src="{{ asset('') }}images/avatar/avatar-group1.png" alt="" class="w-8 h-8 rounded-full object-fit-cover relative">
                        <img src="{{ asset('') }}images/avatar/avatar-group2.png" alt="" class="w-8 h-8 rounded-full object-fit-cover relative ms--10px">
                        <img src="{{ asset('') }}images/avatar/avatar-group3.png" alt="" class="w-8 h-8 rounded-full object-fit-cover relative ms--10px">
                        <img src="{{ asset('') }}images/avatar/avatar-group4.png" alt="" class="w-8 h-8 rounded-full object-fit-cover relative ms--10px">
                        <img src="{{ asset('') }}images/avatar/avatar-group5.png" alt="" class="w-8 h-8 rounded-full object-fit-cover relative ms--10px">
                        <img src="{{ asset('') }}images/avatar/avatar-group6.png" alt="" class="w-8 h-8 rounded-full object-fit-cover relative ms--10px">
                        <img src="{{ asset('') }}images/avatar/avatar-group6.png" alt="" class="w-8 h-8 rounded-full object-fit-cover relative ms--10px">
                ...
                <div class="card-body p-6">
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                        <div class="flex items-center gap-2">
                            <img src="{{ asset('') }}images/avatar/avatar1.png" alt="" class="w-8 h-8 rounded-full object-fit-cover shrink-0">
                        ...
                        <div class="flex items-center gap-2">
                            <img src="{{ asset('') }}images/avatar/avatar2.png" alt="" class="w-8 h-8 rounded-full object-fit-cover shrink-0">
                            <div class="grow inline-flex flex-col">
