                    ...
                    <tbody class="bg-white divide-y divide-shark-100">
                        @foreach ($clients as $client)
                            <tr>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="flex items-center">
                                        <div class="h-10 w-10 flex-shrink-0">
                                            <img class="h-10 w-10 rounded-full bg-shark-200 border border-shark-950"
                                                src="{{ $client->image }}" alt="">
                                        </div>
                                        <div class="ml-4 w-64">
                                            <h3 class="text-sm text-wrap font-medium text-shark-900">
                                                {{ $client->name }}
                                            </h3>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-shark-900">{{ $client->type }}</td>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-shark-500">
                                    {{ $client->expiry_date->format('Y-m-d') }}
                                </td>
