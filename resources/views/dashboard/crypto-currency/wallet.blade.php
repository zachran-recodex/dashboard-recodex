                    ...
                    <div class="table-responsive scroll-sm">
                        <table class="table bordered-table sm-table mb-0">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="flex items-center">
                                        <img src="{{ asset('') }}images/crypto/crypto-img1.png" alt="" class="w-10 h-10 rounded-full shrink-0 me-2 overflow-hidden">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="flex items-center">
                                        <img src="{{ asset('') }}images/crypto/crypto-img2.png" alt="" class="w-10 h-10 rounded-full shrink-0 me-2 overflow-hidden">
                                        <div class="grow flex flex-col">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="flex items-center">
                                        <img src="{{ asset('') }}images/crypto/crypto-img3.png" alt="" class="w-10 h-10 rounded-full shrink-0 me-2 overflow-hidden">
                                        <div class="grow flex flex-col">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="flex items-center">
                                        <img src="{{ asset('') }}images/crypto/crypto-img4.png" alt="" class="w-10 h-10 rounded-full shrink-0 me-2 overflow-hidden">
                                        <div class="grow flex flex-col">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="flex items-center">
                                        <img src="{{ asset('') }}images/crypto/crypto-img6.png" alt="" class="w-10 h-10 rounded-full shrink-0 me-2 overflow-hidden">
                                        <div class="grow flex flex-col">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="flex items-center">
                                        <img src="{{ asset('') }}images/crypto/crypto-img5.png" alt="" class="w-10 h-10 rounded-full shrink-0 me-2 overflow-hidden">
                                        <div class="grow flex flex-col">
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div class="flex flex-col gap-2 p-6">
                    ...
                    <span class="flex items-center gap-4">
                        <img src="{{ asset('') }}images/crypto/wallet-icon1.png" alt="" class="shrink-0 me-3 overflow-hidden">
                        <span class="text-base mb-0 font-medium text-neutral-600 dark:text-neutral-200 block">Bitcoin</span>
                    </span>
                    ...
                    <a href="javascript:void(0)" class="flex items-center justify-between gap-2 p-4 border border-neutral-200 dark:border-neutral-600 rounded-lg hover:bg-neutral-50 dark:hover:bg-neutral-600">
                    <span class="flex items-center gap-4">
                        <img src="{{ asset('') }}images/crypto/wallet-icon2.png" alt="" class="shrink-0 me-3 overflow-hidden">
                    ...
                    <a href="javascript:void(0)" class="flex items-center justify-between gap-2 p-4 border border-neutral-200 dark:border-neutral-600 rounded-lg hover:bg-neutral-50 dark:hover:bg-neutral-600">
                    <span class="flex items-center gap-4">
                        <img src="{{ asset('') }}images/crypto/wallet-icon3.png" alt="" class="shrink-0 me-3 overflow-hidden">
                    ...
                    <a href="javascript:void(0)" class="flex items-center justify-between gap-2 p-4 border border-neutral-200 dark:border-neutral-600 rounded-lg hover:bg-neutral-50 dark:hover:bg-neutral-600">
                    <span class="flex items-center gap-4">
                        <img src="{{ asset('') }}images/crypto/wallet-icon4.png" alt="" class="shrink-0 me-3 overflow-hidden">
