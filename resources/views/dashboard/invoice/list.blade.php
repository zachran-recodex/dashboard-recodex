                ...
                <div class="card-header flex flex-wrap items-center justify-between gap-3">
                  ...
                  <iconify-icon icon="ion:search-outline"></iconify-icon>
                    ...
                    <div class="flex flex-wrap items-center gap-3">
                        ...
                        <a href="invoice-add.html" class="btn btn-sm text-white bg-primary-600 hover:bg-primary-700 flex items-center gap-2"><i class="ri-add-line"></i> Create Invoice</a>
                    </div>
                </div>
                <div class="card-body">
