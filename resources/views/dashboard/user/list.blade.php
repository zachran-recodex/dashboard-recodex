        ...
        <div class="col-span-12">
            <div class="card h-full p-0 rounded-xl border-0 overflow-hidden">
                <div class="card-header border-b border-neutral-200 dark:border-neutral-600 bg-white dark:bg-neutral-700 py-4 px-6 flex items-center flex-wrap gap-3 justify-between">
                    ...
                    <a href="add-user.html" class="btn btn-primary text-sm btn-sm px-3 py-3 rounded-lg flex items-center gap-2">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="flex items-center">
                                        <img src="{{ asset('') }}images/user-list/user-list1.png" alt=""
                      ...
                      <span
                          class="bg-success-100 dark:bg-success-600/25 text-success-600 dark:text-success-400 border border-success-600 px-6 py-1.5 rounded font-medium text-sm">Active</span>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="flex items-center">
                                        <img src="{{ asset('') }}images/user-list/user-list2.png" alt=""
                                             class="w-10 h-10 rounded-full shrink-0 me-2 overflow-hidden">
                                        <div class="grow">
                      ...
                      <span
                          class="bg-neutral-200 dark:bg-neutral-600 text-neutral-600 border border-neutral-400 px-6 py-1.5 rounded font-medium text-sm">Inactive</span>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="flex items-center">
                                        <img src="{{ asset('') }}images/user-list/user-list3.png" alt=""
                                             class="w-10 h-10 rounded-full shrink-0 me-2 overflow-hidden">
                                        <div class="grow">
                      ...
                      <span
                          class="bg-success-100 dark:bg-success-600/25 text-success-600 dark:text-success-400 border border-success-600 px-6 py-1.5 rounded font-medium text-sm">Active</span>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="flex items-center">
                                        <img src="{{ asset('') }}images/user-list/user-list4.png" alt=""
                                             class="w-10 h-10 rounded-full shrink-0 me-2 overflow-hidden">
                                        <div class="grow">
                      ...
                      <span
                          class="bg-success-100 dark:bg-success-600/25 text-success-600 dark:text-success-400 border border-success-600 px-6 py-1.5 rounded font-medium text-sm">Active</span>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="flex items-center">
                                        <img src="{{ asset('') }}images/user-list/user-list5.png" alt=""
                                             class="w-10 h-10 rounded-full shrink-0 me-2 overflow-hidden">
                                        <div class="grow">
                      ...
                      <span
                          class="bg-neutral-200 dark:bg-neutral-600 text-neutral-600 border border-neutral-400 px-6 py-1.5 rounded font-medium text-sm">Inactive</span>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="flex items-center">
                                        <img src="{{ asset('') }}images/user-list/user-list6.png" alt=""
                                             class="w-10 h-10 rounded-full shrink-0 me-2 overflow-hidden">
                                        <div class="grow">
                      ...
                      <span
                          class="bg-success-100 dark:bg-success-600/25 text-success-600 dark:text-success-400 border border-success-600 px-6 py-1.5 rounded font-medium text-sm">Active</span>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="flex items-center">
                                        <img src="{{ asset('') }}images/user-list/user-list7.png" alt=""
                                             class="w-10 h-10 rounded-full shrink-0 me-2 overflow-hidden">
                                        <div class="grow">
                      ...
                      <span
                          class="bg-success-100 dark:bg-success-600/25 text-success-600 dark:text-success-400 border border-success-600 px-6 py-1.5 rounded font-medium text-sm">Active</span>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="flex items-center">
                                        <img src="{{ asset('') }}images/user-list/user-list8.png" alt=""
                                             class="w-10 h-10 rounded-full shrink-0 me-2 overflow-hidden">
                                        <div class="grow">
                      ...
                      <span
                          class="bg-success-100 dark:bg-success-600/25 text-success-600 dark:text-success-400 border border-success-600 px-6 py-1.5 rounded font-medium text-sm">Active</span>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="flex items-center">
                                        <img src="{{ asset('') }}images/user-list/user-list10.png" alt=""
                                             class="w-10 h-10 rounded-full shrink-0 me-2 overflow-hidden">
                                        <div class="grow">
