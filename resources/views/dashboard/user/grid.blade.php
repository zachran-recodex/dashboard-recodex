<x-dashboard-layout>
    ...
    <div class="card h-full p-0 rounded-xl border-0 overflow-hidden">
        <div class="card-header border-b border-neutral-200 dark:border-neutral-600 bg-white dark:bg-neutral-700 py-4 px-6 flex items-center flex-wrap gap-3 justify-between">
            ...
            <a href="view-profile.html" class="btn btn-primary text-sm btn-sm px-3 py-3 rounded-lg flex items-center gap-2">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 2xl:grid-cols-3 3xl:grid-cols-4 gap-6">
                <div class="user-grid-card">
                    <div class="relative border border-neutral-200 dark:border-neutral-600 rounded-2xl overflow-hidden">
                        <img src="{{ asset('') }}images/user-grid/user-grid-bg1.png" alt="" class="w-full object-fit-cover">
                        ...
                        <div class="pe-6 pb-4 ps-6 text-center mt--50">
                            <img src="{{ asset('') }}images/user-grid/user-grid-img1.png" alt="" class="border br-white border-width-2-px w-[100px] h-[100px] ms-auto me-auto -mt-[50px] rounded-full object-fit-cover">
                ...
                <div class="user-grid-card">
                    <div class="relative border border-neutral-200 dark:border-neutral-600 rounded-2xl overflow-hidden">
                        <img src="{{ asset('') }}images/user-grid/user-grid-bg2.png" alt="" class="w-full object-fit-cover">
                        ...
                        <div class="pe-6 pb-4 ps-6 text-center mt--50">
                            <img src="{{ asset('') }}images/user-grid/user-grid-img2.png" alt="" class="border br-white border-width-2-px w-[100px] h-[100px] ms-auto me-auto -mt-[50px] rounded-full object-fit-cover">
                ...
                <div class="user-grid-card">
                    <div class="relative border border-neutral-200 dark:border-neutral-600 rounded-2xl overflow-hidden">
                        <img src="{{ asset('') }}images/user-grid/user-grid-bg3.png" alt="" class="w-full object-fit-cover">
                        ...
                        <div class="pe-6 pb-4 ps-6 text-center mt--50">
                            <img src="{{ asset('') }}images/user-grid/user-grid-img3.png" alt="" class="border br-white border-width-2-px w-[100px] h-[100px] ms-auto me-auto -mt-[50px] rounded-full object-fit-cover">
                ...
                <div class="user-grid-card">
                    <div class="relative border border-neutral-200 dark:border-neutral-600 rounded-2xl overflow-hidden">
                        <img src="{{ asset('') }}images/user-grid/user-grid-bg4.png" alt="" class="w-full object-fit-cover">
                        ...
                        <div class="pe-6 pb-4 ps-6 text-center mt--50">
                            <img src="{{ asset('') }}images/user-grid/user-grid-img4.png" alt="" class="border br-white border-width-2-px w-[100px] h-[100px] ms-auto me-auto -mt-[50px] rounded-full object-fit-cover">
                ...
                <div class="user-grid-card">
                    <div class="relative border border-neutral-200 dark:border-neutral-600 rounded-2xl overflow-hidden">
                        <img src="{{ asset('') }}images/user-grid/user-grid-bg5.png" alt="" class="w-full object-fit-cover">
                        ...
                        <div class="pe-6 pb-4 ps-6 text-center mt--50">
                            <img src="{{ asset('') }}images/user-grid/user-grid-img5.png" alt="" class="border br-white border-width-2-px w-[100px] h-[100px] ms-auto me-auto -mt-[50px] rounded-full object-fit-cover">
                ...
                <div class="user-grid-card">
                    <div class="relative border border-neutral-200 dark:border-neutral-600 rounded-2xl overflow-hidden">
                        <img src="{{ asset('') }}images/user-grid/user-grid-bg6.png" alt="" class="w-full object-fit-cover">
                        ...
                        <div class="pe-6 pb-4 ps-6 text-center mt--50">
                            <img src="{{ asset('') }}images/user-grid/user-grid-img6.png" alt="" class="border br-white border-width-2-px w-[100px] h-[100px] ms-auto me-auto -mt-[50px] rounded-full object-fit-cover">
                ...
                <div class="user-grid-card">
                    <div class="relative border border-neutral-200 dark:border-neutral-600 rounded-2xl overflow-hidden">
                        <img src="{{ asset('') }}images/user-grid/user-grid-bg7.png" alt="" class="w-full object-fit-cover">
                        ...
                        <div class="pe-6 pb-4 ps-6 text-center mt--50">
                            <img src="{{ asset('') }}images/user-grid/user-grid-img7.png" alt="" class="border br-white border-width-2-px w-[100px] h-[100px] ms-auto me-auto -mt-[50px] rounded-full object-fit-cover">
                ...
                <div class="user-grid-card">
                    <div class="relative border border-neutral-200 dark:border-neutral-600 rounded-2xl overflow-hidden">
                        <img src="{{ asset('') }}images/user-grid/user-grid-bg8.png" alt="" class="w-full object-fit-cover">
                        ...
                        <div class="pe-6 pb-4 ps-6 text-center mt--50">
                            <img src="{{ asset('') }}images/user-grid/user-grid-img8.png" alt="" class="border br-white border-width-2-px w-[100px] h-[100px] ms-auto me-auto -mt-[50px] rounded-full object-fit-cover">
                ...
                <div class="user-grid-card">
                    <div class="relative border border-neutral-200 dark:border-neutral-600 rounded-2xl overflow-hidden">
                        <img src="{{ asset('') }}images/user-grid/user-grid-bg9.png" alt="" class="w-full object-fit-cover">
                        ...
                        <div class="pe-6 pb-4 ps-6 text-center mt--50">
                            <img src="{{ asset('') }}images/user-grid/user-grid-img9.png" alt="" class="border br-white border-width-2-px w-[100px] h-[100px] ms-auto me-auto -mt-[50px] rounded-full object-fit-cover">
                ...
                <div class="user-grid-card">
                    <div class="relative border border-neutral-200 dark:border-neutral-600 rounded-2xl overflow-hidden">
                        <img src="{{ asset('') }}images/user-grid/user-grid-bg10.png" alt="" class="w-full object-fit-cover">
                        ...
                        <div class="pe-6 pb-4 ps-6 text-center mt--50">
                            <img src="{{ asset('') }}images/user-grid/user-grid-img10.png" alt="" class="border br-white border-width-2-px w-[100px] h-[100px] ms-auto me-auto -mt-[50px] rounded-full object-fit-cover">
                ...
                <div class="user-grid-card">
                    <div class="relative border border-neutral-200 dark:border-neutral-600 rounded-2xl overflow-hidden">
                        <img src="{{ asset('') }}images/user-grid/user-grid-bg11.png" alt="" class="w-full object-fit-cover">
                        ...
                        <div class="pe-6 pb-4 ps-6 text-center mt--50">
                            <img src="{{ asset('') }}images/user-grid/user-grid-img11.png" alt="" class="border br-white border-width-2-px w-[100px] h-[100px] ms-auto me-auto -mt-[50px] rounded-full object-fit-cover">
                ...
                <div class="user-grid-card">
                    <div class="relative border border-neutral-200 dark:border-neutral-600 rounded-2xl overflow-hidden">
                        <img src="{{ asset('') }}images/user-grid/user-grid-bg12.png" alt="" class="w-full object-fit-cover">
                        ...
                        <div class="pe-6 pb-4 ps-6 text-center mt--50">
                            <img src="{{ asset('') }}images/user-grid/user-grid-img12.png" alt="" class="border br-white border-width-2-px w-[100px] h-[100px] ms-auto me-auto -mt-[50px] rounded-full object-fit-cover">
