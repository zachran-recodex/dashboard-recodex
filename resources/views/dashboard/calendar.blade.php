                ...
                <form action="#">
                    <div class="grid grid-cols-1 md:grid-cols-12 gap-6">
                        ...
                        <div class="col-span-12 md:col-span-6">
                            ...
                            <div class=" relative">
                                <input class="form-control rounded-lg" id="editstartDate" type="text" placeholder="03/12/2024, 10:30 AM">
                                <span class="absolute end-0 top-1/2 -translate-y-1/2 me-3 line-height-1"><iconify-icon icon="solar:calendar-linear" class="icon text-lg"></iconify-icon></span>
                            </div>
                        </div>
                        <div class="col-span-12 md:col-span-6">
                            ...
                            <div class=" relative">
                                <input class="form-control rounded-lg" id="editendDate" type="text" placeholder="03/12/2024, 2:30 PM">
                                <span class="absolute end-0 top-1/2 -translate-y-1/2 me-3 line-height-1"><iconify-icon icon="solar:calendar-linear" class="icon text-lg"></iconify-icon></span>
                            </div>
                        </div>
                        <div class="col-span-12">
