                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 2xl:grid-cols-4 gap-6">
                        <div class="hover-scale-img border border-neutral-200 dark:border-neutral-600 rounded-2xl overflow-hidden">
                            <div class="max-h-[266px] overflow-hidden">
                                <img src="{{ asset('') }}images/gallery/gallery-img8.png" alt="" class="hover-scale-img__img w-full h-full object-fit-cover">
                            </div>
                            <div class="py-4 px-6">
                        ...
                        <div class="hover-scale-img border border-neutral-200 dark:border-neutral-600 rounded-2xl overflow-hidden">
                            <div class="max-h-[266px] overflow-hidden">
                                <img src="{{ asset('') }}images/gallery/gallery-img9.png" alt="" class="hover-scale-img__img w-full h-full object-fit-cover">
                            </div>
                            <div class="py-4 px-6">
                                <h6 class="mb-1.5">This is Image title</h6>
                                <p class="mb-0 text-sm text-secondary-light">UI Design</p>
                        ...
                        <div class="hover-scale-img border border-neutral-200 dark:border-neutral-600 rounded-2xl overflow-hidden">
                            <div class="max-h-[266px] overflow-hidden">
                                <img src="{{ asset('') }}images/gallery/gallery-img10.png" alt="" class="hover-scale-img__img w-full h-full object-fit-cover">
                            </div>
                            <div class="py-4 px-6">
                                <h6 class="mb-1.5">This is Image title</h6>
                                <p class="mb-0 text-sm text-secondary-light">UI Design</p>
                        ...
                        <div class="hover-scale-img border border-neutral-200 dark:border-neutral-600 rounded-2xl overflow-hidden">
                            <div class="max-h-[266px] overflow-hidden">
                                <img src="{{ asset('') }}images/gallery/gallery-img11.png" alt="" class="hover-scale-img__img w-full h-full object-fit-cover">
                            </div>
                            <div class="py-4 px-6">
                                <h6 class="mb-1.5">This is Image title</h6>
                                <p class="mb-0 text-sm text-secondary-light">UI Design</p>
                        ...
                        <div class="hover-scale-img border border-neutral-200 dark:border-neutral-600 rounded-2xl overflow-hidden">
                            <div class="max-h-[266px] overflow-hidden">
                                <img src="{{ asset('') }}images/gallery/gallery-img12.png" alt="" class="hover-scale-img__img w-full h-full object-fit-cover">
                            </div>
                            <div class="py-4 px-6">
                                <h6 class="mb-1.5">This is Image title</h6>
                                <p class="mb-0 text-sm text-secondary-light">UI Design</p>
                        ...
                        <div class="hover-scale-img border border-neutral-200 dark:border-neutral-600 rounded-2xl overflow-hidden">
                            <div class="max-h-[266px] overflow-hidden">
                                <img src="{{ asset('') }}images/gallery/gallery-img1.png" alt="" class="hover-scale-img__img w-full h-full object-fit-cover">
                            </div>
                            <div class="py-4 px-6">
                                <h6 class="mb-1.5">This is Image title</h6>
                                <p class="mb-0 text-sm text-secondary-light">UI Design</p>
                        ...
                        <div class="hover-scale-img border border-neutral-200 dark:border-neutral-600 rounded-2xl overflow-hidden">
                            <div class="max-h-[266px] overflow-hidden">
                                <img src="{{ asset('') }}images/gallery/gallery-img2.png" alt="" class="hover-scale-img__img w-full h-full object-fit-cover">
                            </div>
                            <div class="py-4 px-6">
                                <h6 class="mb-1.5">This is Image title</h6>
                                <p class="mb-0 text-sm text-secondary-light">UI Design</p>
                        ...
                        <div class="hover-scale-img border border-neutral-200 dark:border-neutral-600 rounded-2xl overflow-hidden">
                            <div class="max-h-[266px] overflow-hidden">
                                <img src="{{ asset('') }}images/gallery/gallery-img3.png" alt="" class="hover-scale-img__img w-full h-full object-fit-cover">
                            </div>
                            <div class="py-4 px-6">
                                <h6 class="mb-1.5">This is Image title</h6>
                                <p class="mb-0 text-sm text-secondary-light">UI Design</p>
                        ...
                        <div class="hover-scale-img border border-neutral-200 dark:border-neutral-600 rounded-2xl overflow-hidden">
                            <div class="max-h-[266px] overflow-hidden">
                                <img src="{{ asset('') }}images/gallery/gallery-img4.png" alt="" class="hover-scale-img__img w-full h-full object-fit-cover">
                            </div>
                            <div class="py-4 px-6">
                                <h6 class="mb-1.5">This is Image title</h6>
                                <p class="mb-0 text-sm text-secondary-light">UI Design</p>
                        ...
                        <div class="hover-scale-img border border-neutral-200 dark:border-neutral-600 rounded-2xl overflow-hidden">
                            <div class="max-h-[266px] overflow-hidden">
                                <img src="{{ asset('') }}images/gallery/gallery-img5.png" alt="" class="hover-scale-img__img w-full h-full object-fit-cover">
                            </div>
                            <div class="py-4 px-6">
                                <h6 class="mb-1.5">This is Image title</h6>
                                <p class="mb-0 text-sm text-secondary-light">UI Design</p>
                        ...
                        <div class="hover-scale-img border border-neutral-200 dark:border-neutral-600 rounded-2xl overflow-hidden">
                            <div class="max-h-[266px] overflow-hidden">
                                <img src="{{ asset('') }}images/gallery/gallery-img6.png" alt="" class="hover-scale-img__img w-full h-full object-fit-cover">
                            </div>
                            <div class="py-4 px-6">
                                <h6 class="mb-1.5">This is Image title</h6>
                                <p class="mb-0 text-sm text-secondary-light">UI Design</p>
                        ...
                        <div class="hover-scale-img border border-neutral-200 dark:border-neutral-600 rounded-2xl overflow-hidden">
                            <div class="max-h-[266px] overflow-hidden">
                                <img src="{{ asset('') }}images/gallery/gallery-img7.png" alt="" class="hover-scale-img__img w-full h-full object-fit-cover">
                            </div>
                            <div class="py-4 px-6">
                                <h6 class="mb-1.5">This is Image title</h6>
                                <p class="mb-0 text-sm text-secondary-light">UI Design</p>
