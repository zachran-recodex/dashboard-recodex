                    ...
                    <div class="table-responsive">
                        <table class="table border-0 mb-0">
                            ...
                            <tr>
                                ...
                                <td class="!border-b-0">25 Jan 2024</td>
                            ...
                            <tr>
                                ...
                                <td class="!border-b-0">10 Feb 2024</td>
                                <td class="!border-b-0">$200.00</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td class="!border-b-0">15 Mar 2024</td>
                                <td class="!border-b-0">$150.00</td>
                            </tr>
                            </tbody>
                        </table>
                    ...
                    <div class="table-responsive">
                        <table class="table basic-border-table mb-0">
                            ...
                            <tr>
                                ...
                                <td class="border-r border-neutral-200 dark:border-neutral-600 last:border-r-0">25 Jan 2024</td>
                            ...
                            <tr>
                                ...
                                <td class="border-r border-neutral-200 dark:border-neutral-600 last:border-r-0">10 Feb 2024</td>
                                <td class="border-r border-neutral-200 dark:border-neutral-600 last:border-r-0">$200.00</td>
                                <td class="border-r border-neutral-200 dark:border-neutral-600 last:border-r-0">
                                    <a href="javascript:void(0)" class="text-primary-600">View More ></a>
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="border-r border-neutral-200 dark:border-neutral-600 last:border-r-0">15 Mar 2024</td>
                                <td class="border-r border-neutral-200 dark:border-neutral-600 last:border-r-0">$150.00</td>
                                <td class="border-r border-neutral-200 dark:border-neutral-600 last:border-r-0">
                                    <a href="javascript:void(0)" class="text-primary-600">View More ></a>
                                </td>
                    ...
                    <div class="table-responsive">
                        <table class="table striped-table mb-0">
                            ...
                            <tr class="odd:bg-neutral-100 dark:odd:bg-neutral-600">
                                <td>
                                    <div class="flex items-center">
                                        <img src="{{ asset('') }}images/product/product-img1.png" alt="" class="shrink-0 me-3 rounded-lg me-3">
                                        <div class="grow">
                            ...
                            <tr class="odd:bg-neutral-100 dark:odd:bg-neutral-600">
                                <td>
                                    <div class="flex items-center">
                                        <img src="{{ asset('') }}images/product/product-img2.png" alt="" class="shrink-0 me-3 rounded-lg me-3">
                                        <div class="grow">
                            ...
                            <tr class="odd:bg-neutral-100 dark:odd:bg-neutral-600">
                                <td>
                                    <div class="flex items-center">
                                        <img src="{{ asset('') }}images/product/product-img3.png" alt="" class="shrink-0 me-3 rounded-lg me-3">
                                        <div class="grow">
                            ...
                            <tr class="odd:bg-neutral-100 dark:odd:bg-neutral-600">
                                <td>
                                    <div class="flex items-center">
                                        <img src="{{ asset('') }}images/product/product-img4.png" alt="" class="shrink-0 me-3 rounded-lg me-3">
                                        <div class="grow">
                            ...
                            <tr class="odd:bg-neutral-100 dark:odd:bg-neutral-600">
                                <td>
                                    <div class="flex items-center">
                                        <img src="{{ asset('') }}images/product/product-img5.png" alt="" class="shrink-0 me-3 rounded-lg me-3">
                                        <div class="grow">
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table colored-row-table mb-0">
                            ...
                            <tbody>
                            <tr>
                                <td class="bg-primary-50 dark:bg-primary-600/10">27 Mar 2024</td>
                                <td class="bg-primary-50 dark:bg-primary-600/10">
                                    <div class="flex items-center">
                                        <img src="{{ asset('') }}images/users/user1.png" alt="" class="w-10 h-10 rounded-full shrink-0 me-2 overflow-hidden">
                            ...
                            <tr>
                                <td class="bg-success-100 dark:bg-success-600/10">27 Mar 2024</td>
                                <td class="bg-success-100 dark:bg-success-600/10">
                                    <div class="flex items-center">
                                        <img src="{{ asset('') }}images/users/user2.png" alt="" class="w-10 h-10 rounded-full shrink-0 me-2 overflow-hidden">
                            ...
                            <tr>
                                <td class="bg-info-100 dark:bg-info-600/10">27 Mar 2024</td>
                                <td class="bg-info-100 dark:bg-info-600/10">
                                    <div class="flex items-center">
                                        <img src="{{ asset('') }}images/users/user3.png" alt="" class="w-10 h-10 rounded-full shrink-0 me-2 overflow-hidden">
                            ...
                            <tr>
                                <td class="bg-warning-100 dark:bg-warning-600/10">27 Mar 2024</td>
                                <td class="bg-warning-100 dark:bg-warning-600/10">
                                    <div class="flex items-center">
                                        <img src="{{ asset('') }}images/users/user4.png" alt="" class="w-10 h-10 rounded-full shrink-0 me-2 overflow-hidden">
                            ...
                            <tr>
                                <td class="bg-danger-100 dark:bg-danger-600/10">27 Mar 2024</td>
                                <td class="bg-danger-100 dark:bg-danger-600/10">
                                    <div class="flex items-center">
                                        <img src="{{ asset('') }}images/users/user5.png" alt="" class="w-10 h-10 rounded-full shrink-0 me-2 overflow-hidden">
                    ...
                    <div class="table-responsive">
                        <table class="table bordered-table mb-0">
                            ...
                            <tr>
                                <td>
                                    <div class="flex items-center">
                                        <img src="{{ asset('') }}images/users/user1.png" alt="" class="shrink-0 me-3 rounded-lg">
                                ...
                                <td class="text-center"> <span
                                        class="bg-success-100 dark:bg-success-600/25 text-success-600 dark:text-success-400 px-6 py-1.5 rounded-full font-medium text-sm">Paid</span> </td>
                            </tr>
                            <tr>
                                <td>
                                    <div class="flex items-center">
                                        <img src="{{ asset('') }}images/users/user2.png" alt="" class="shrink-0 me-3 rounded-lg">
                                ...
                                <td>$1,000.00</td>
                                <td class="text-center"> <span
                                        class="bg-warning-100 dark:bg-warning-600/25 text-warning-600 dark:text-warning-400 px-6 py-1.5 rounded-full font-medium text-sm">Pending</span> </td>
                            </tr>
                            <tr>
                                <td>
                                    <div class="flex items-center">
                                        <img src="{{ asset('') }}images/users/user3.png" alt="" class="shrink-0 me-3 rounded-lg">
                                ...
                                <td>$1,000.00</td>
                                <td class="text-center"> <span
                                        class="bg-info-100 dark:bg-info-600/25 text-info-600 dark:text-info-400 px-6 py-1.5 rounded-full font-medium text-sm">Shipped</span> </td>
                            </tr>
                            <tr>
                                <td>
                                    <div class="flex items-center">
                                        <img src="{{ asset('') }}images/users/user4.png" alt="" class="shrink-0 me-3 rounded-lg">
                                ...
                                <td>$3,000.00</td>
                                <td class="text-center"> <span
                                        class="bg-danger-100 dark:bg-danger-600/25 text-danger-600 dark:text-danger-400 px-6 py-1.5 rounded-full font-medium text-sm">Canceled</span> </td>
                            </tr>
                            <tr>
                                <td>
                                    <div class="flex items-center">
                                        <img src="{{ asset('') }}images/users/user5.png" alt="" class="shrink-0 me-3 rounded-lg">
